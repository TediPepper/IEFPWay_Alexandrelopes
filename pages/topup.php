                        ...
                        <div class="form-bottom">
                            <form role="form"  method="post" class="login-form">
                                ...
                                if(isset($_POST["form-value"])){
                                    ...
                                    $total = $result["Balance"] + $_POST["form-value"] ;

                                    // Fazer update no balance do cartão obtido.
                                    $sql2 = $conn->prepare("UPDATE card SET balance = ? WHERE id = ?");
                                    $sql2->bind_param("ss", $total, $_SESSION["id"] );
                                    $sql2->execute();
                                    ...
                                    if (mysqli_error($conn)) { ?>
                                      ...
                                      <?php }else{ ?>
                                                  <div class="alert alert-success" role="alert">
                                                    Success - Current balance: <?php echo $total;?> ¥
                                                 </div>
